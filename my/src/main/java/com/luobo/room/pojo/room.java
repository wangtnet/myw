...
public class room {
    ...
    public Boolean getAircondtioner() {
        return aircondtioner;
    }

    public void setAircondtioner(Boolean aircondtioner) {
        this.aircondtioner = aircondtioner;
    }
